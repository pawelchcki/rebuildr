...
def test_sha_sum():
    ...
    assert desc.sha_sum() == "ceb4a0286c40df1f8d7a090b8771f7cbfc2e976e8c915f6a1e23f925e290c9ef", "sha sum is not correct"
    assert desc.sha_sum() == m.hexdigest()

    # changing the env should change the sha sum
    import os
    os.environ["EXAMPLE_ENV"] = "something else"
    assert desc.sha_sum() == "8a3d317957285aebdcb1154c335e6c46b257ceef03990adbf3295cea73bc9012"
